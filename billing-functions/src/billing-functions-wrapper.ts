...
export type BILLING_FUNCTION_WRAPPER_HANDLERS = {
  ...
  getBillingPortalUrl: (args: GET_BILLING_PORTAL_URL_ARGS) => Promise<GENERIC_URL_RESPONSE>;
  getNewSubscriptionUrl: (args: GET_NEW_SUBSCRIPTION_URL_ARGS) => Promise<GENERIC_URL_RESPONSE>;
  getBillingStatus: (args: GET_BILLING_STATUS_ARGS) => Promise<BASEJUMP_BILLING_DATA_UPSERT>;
};
        ...
        case "get_billing_status":
          return await requireAuthorizedBillingUser(req, {
            ...
            async onBillableAndAuthorized(roleInfo) {
              ...
              const response = await getBillingStatus(supabaseClient, roleInfo, handlers);
